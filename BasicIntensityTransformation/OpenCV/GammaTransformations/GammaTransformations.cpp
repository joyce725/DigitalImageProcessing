...
printf("Please input the gamma value.Note that if gamma<1,you will get a lighter image,otherwise you will get a darker one. Besides,if gamma=1,the processed image will be the same as the origin one.");
scanf("%lf",&gamma);
